...
final notificationDummies = <TtossNotification>[
  TtossNotification(NotificationType.tossPay,
      '이번주에 영화 한편 어때여? CGV 할인 쿠폰이 도착했어요.', DateTime.now().subtract(27.minutes)),
  TtossNotification(NotificationType.moneyTip, '인적분할에 대해 알려드릴게요.',
      DateTime.now().subtract(1.hours)),
  TtossNotification(NotificationType.walk, '5,000걸음 이상 걸었다면 포인트 받으세요.',
      DateTime.now().subtract(1.hours),
      isRead: true),
  TtossNotification(
      NotificationType.moneyTip,
      '유럽 식품 물가가 치솟고 있어요.\n남반석님, 유럽 여행에 관심이 있다면 확인해보세요.',
      DateTime.now().subtract(8.hours),
      isRead: true),
  TtossNotification(NotificationType.walk, '오늘 1,000걸음 넘겼어요. 포인트를 받아보세요.',
      DateTime.now().subtract(11.hours)),
  TtossNotification(NotificationType.tossPay,
      '이번주에 영화 한편 어때여? CGV 할인 쿠폰이 도착했어요', DateTime.now().subtract(12.hours)),
